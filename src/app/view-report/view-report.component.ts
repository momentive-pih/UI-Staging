...
export class ViewReportComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // List sidebarCategoriesData API Call
...
//PDF Download Function
  ...
  //Sub Categories Selecting Function
  topCheckBox(checkStatus, data) {
    ...
    this.ReportViewCheck.some(element => {
      element != element.checkValue;
  ...
  //Sub-level-child selecting Function
  subCheckBox(checkStatus, data, id, product_Name, top_id) {
    ...
    if (checkStatus === false) {
      ...
      this.sidebarCategoriesData.forEach(element => {
        ...
        this.subMenuCheck.every(element => {
        element.checkValue === true;
          let menuCheck = element.checkValue;
          if (menuCheck === true) {
  ...
  //Data sperate call in report View
  reportView() {
